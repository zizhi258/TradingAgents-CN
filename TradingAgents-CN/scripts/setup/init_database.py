...
def init_mongodb():
    ...
    try:
        ...
        # 创建索引
        stock_data_collection.create_index(
            [("symbol", 1), ("market_type", 1)], unique=True
        )
        ...
        config_collection.create_index(
            [("config_type", 1), ("config_name", 1)], unique=True
        )
...
def init_redis():
    ...
    try:
        ...
        db_manager.cache_set(
            "system:cache_config", cache_config, ttl=86400 * 30
        )  # 30天
