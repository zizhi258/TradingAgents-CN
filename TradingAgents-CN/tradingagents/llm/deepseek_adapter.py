...
def create_deepseek_adapter(
    model: str = "deepseek-chat", temperature: float = 0.1, **kwargs
) -> DeepSeekAdapter:
    """
    便捷函数：创建DeepSeek适配器
    ...
    """
    return DeepSeekAdapter(model=model, temperature=temperature, **kwargs)


# 导出主要类和函数
__all__ = ["DeepSeekAdapter", "create_deepseek_adapter"]
