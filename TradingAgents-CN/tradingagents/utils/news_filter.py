...
class NewsRelevanceFilter:
    ...
    def get_filter_statistics(
        ...
        stats = {
            ...
            "avg_score": (
                filtered_df["relevance_score"].mean() if not filtered_df.empty else 0
            ),
            "max_score": (
                filtered_df["relevance_score"].max() if not filtered_df.empty else 0
            ),
            "min_score": (
                filtered_df["relevance_score"].min() if not filtered_df.empty else 0
            ),
        }
