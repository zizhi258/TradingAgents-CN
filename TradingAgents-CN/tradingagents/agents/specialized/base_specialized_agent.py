    ...
    def analyze(
        ...
        try:
            ...
            analysis_result = AgentAnalysisResult(
                ...
                model_used=(
                    task_result.model_used.name if task_result.model_used else "unknown"
                ),
            ...
            self.logger.info(
                f"分析完成: {self.agent_role}, 置信度: {analysis_result.confidence_score:.3f}"
            )
...
"""
    ...
    def _calculate_confidence_score(
        self, parsed_result: dict[str, Any], metrics: dict[str, Any]
    ) -> float:
        """计算置信度评分"""
        base_score = 0.7  # 基础分数
    ...
    def _update_performance_stats(self, confidence_score: float, success: bool) -> None:
        ...
        if success:
            ...
            self.average_confidence = (
                self.average_confidence * (self.successful_analyses - 1)
                + confidence_score
    ...
    def get_performance_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "performance_grade": self._calculate_performance_grade(
                success_rate, self.average_confidence
            ),
        }
